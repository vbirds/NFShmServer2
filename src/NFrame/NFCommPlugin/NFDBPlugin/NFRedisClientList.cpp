...
bool NFRedisDriver::LLEN(const std::string &key, int& length)
{
...
bool NFRedisDriver::LPOP(const std::string &key, std::string& value)
{
...
int NFRedisDriver::LPUSH(const std::string &key, const std::string &value)
{
...
int NFRedisDriver::LPUSHX(const std::string &key, const std::string &value)
{
...
bool NFRedisDriver::LRANGE(const std::string &key, const int start, const int end, string_vector &values)
{
	if (end - start <= 0)
	{
		return false;
...
bool NFRedisDriver::LSET(const std::string &key, const int index, const std::string &value)
{
...
bool NFRedisDriver::RPOP(const std::string &key, std::string& value)
{
...
int NFRedisDriver::RPUSH(const std::string &key, const std::string &value)
{
...
int NFRedisDriver::RPUSHX(const std::string &key, const std::string &value)
{
