...
bool NFRedisDriver::EXISTS(const std::string &key)
{
...
bool NFRedisDriver::EXPIRE(const std::string &key, const unsigned int secs)
{
...
bool NFRedisDriver::EXPIREAT(const std::string &key, const int64_t unixTime)
{
...
bool NFRedisDriver::PERSIST(const std::string &key)
{
...
int NFRedisDriver::TTL(const std::string &key)
{
...
std::string NFRedisDriver::TYPE(const std::string &key)
{
