...
//    @Desc             :    路由服务器模块接口头文件，提供路由服务器的通用功能接口。
//                          该文件定义了路由服务器模块接口类，包括路由服务器连接管理、
//                          消息处理接口、服务器注册功能、网络事件处理。
//                          主要功能包括提供路由服务器的通用功能接口、支持路由服务器连接管理、
//                          支持消息处理和路由分发、提供网络事件处理。
//                          路由服务器模块接口是NFShmXFrame框架的路由服务器组件，负责：
//                          - 路由服务器的通用功能接口
//                          - 路由服务器连接管理和状态维护
//                          - 消息处理和路由分发
//                          - 服务器注册和发现
 ...
 * 使用方式：
 * @code
 * class MyRouteServerModule : public NFIRouteServerModule {
 * public:
