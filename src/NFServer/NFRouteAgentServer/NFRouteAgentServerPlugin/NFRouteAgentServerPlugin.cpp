// -------------------------------------------------------------------------
//    @FileName         :    NFRouteAgentServerPlugin.cpp
//    @Author           :    Gao.Yi
//    @Date             :   2022-09-18
//    @Email			:    445267987@qq.com
//    @Module           :    NFRouteAgentServerPlugin
//    @Desc             :    NFShmXFrame路由代理服务器插件实现
//                          实现路由代理服务器插件的核心功能，包括插件生命周期管理
//                          提供动态加载接口，支持路由代理和负载均衡服务
// -------------------------------------------------------------------------
 ...
 * @brief 安装插件
 *
 * 注册路由代理服务器模块到插件管理器，添加服务器类型
 */
void NFRouteAgentServerPlugin::Install()
{
	NFGlobalSystem::Instance()->AddServerType(NF_ST_ROUTE_AGENT_SERVER);
	REGISTER_MODULE_TICK(m_pObjPluginManager, NFIRouteAgentServerModule, NFCRouteAgentServerModule);
}
