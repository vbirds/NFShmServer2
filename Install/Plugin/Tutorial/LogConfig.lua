...
NFLogId = {
	...
	NF_LOG_DEFAULT = 3,					--接受消息
	NF_LOG_DEFAULT = 4,		--接受消息Json输出
	NF_LOG_LOAD_CONFIG = 5,				--加载配置
	NF_LOG_DEFAULT = 6,				--protobuf解析出错
	NF_LOG_DEFAULT = 7,			--引擎加载器
...
LogInfo = {
	...
	{logid = NFLogId.NF_LOG_DEFAULT, display=true, level=0, logname = "SystemLog", guid = 0, desc = "系统LOG"},
	{logid = NFLogId.NF_LOG_DEFAULT, display=true, level=0, logname = "RecvMsg", guid = 0, desc = "接受消息LOG"},
	{logid = NFLogId.NF_LOG_DEFAULT, display=true, level=0, logname = "RecvMsgJson", guid = 0, desc = "接受消息Json输出LOG"},
	{logid = NFLogId.NF_LOG_DEFAULT, display=true, level=0, logname = "PluginLog", guid = 0, desc = "引擎管理LOG"},
	{logid = NFLogId.NF_LOG_LOAD_CONFIG, display=true, level=0, logname = "LoadConfigLog", guid = 0, desc = "加载配置LOG"},
	{logid = NFLogId.NF_LOG_DEFAULT, display=true, level=0, logname = "ProtobufParse", guid = 0, desc = "protobuf解析出错LOG"},
}
