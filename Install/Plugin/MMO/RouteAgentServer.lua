...
-- 1服务器索引，范围1-255
RouteAgentServer = {
  RouteAgentServer_1_1 = {
    ServerName = "RouteAgentServer_1_1",
  ...
  RouteAgentServer_2_1 = {
    ServerName = "RouteAgentServer_2_1",
    ServerType = NF_ST_ROUTE_AGENT_SERVER,
    ...
    IdleSleepUS = 1000,
    ServerIp = NF_INTER_SERVER_IP,
    ServerPort = NF_INTER_SERVER_PORT2+NF_ST_ROUTE_AGENT_SERVER*10+1,
    MaxConnectNum = NF_INTER_MAX_CONNECT,
    NetThreadNum = 5,
    WorkThreadNum = 1,
    MaxOnlinePlayerNum = NF_MAX_ONLINE_PLAYER_COUNT,
