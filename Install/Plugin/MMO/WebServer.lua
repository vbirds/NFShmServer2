...
WebServer = {
 ...
 WebServer_2_1 = {
    ServerName = "WebServer_2_1",
    ServerType = NF_ST_WEB_SERVER,
    ServerId = NF_ST_WORLD_ID.."."..NF_ST_ZONE_ID2.."."..NF_ST_WEB_SERVER..".1",			--对每一个服务器来说都是唯一的， 应用程序需要通过这个ServerId才能知道需要加载的配置是他
    BusLength = NF_COMMON_BUS_LENGTH,     --20M共享内存
    LinkMode = NF_LINK_MODE,
    IdleSleepUS = 1000,
    MaxConnectNum = NF_INTER_MAX_CONNECT,
    ...
    WorkThreadNum = 1,
    ServerIp = NF_INTER_SERVER_IP,
    ServerPort = NF_INTER_SERVER_PORT2+NF_ST_WEB_SERVER*10+1,
    HttpPort = NF_EXTER_WEB_SERVER_PORT+1,
    MaxOnlinePlayerNum = NF_MAX_ONLINE_PLAYER_COUNT,
    HandleMsgNumPerFrame = NF_NORMAL_SERVER_HANDLE_MSG_COUNT,
    RouteConfig = {
