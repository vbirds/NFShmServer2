...
CityServer = {
   CityServer_1_1 = {
      ServerName = "CityServer_1_1",
      ServerType = NF_ST_CITY_SERVER,
      ServerId = NF_ST_WORLD_ID.."."..NF_ST_ZONE_ID.."."..NF_ST_CITY_SERVER..".1",			--对每一个服务器来说都是唯一的， 应用程序需要通过这个ServerId才能知道需要加载的配置是他
      LinkMode = NF_LINK_MODE,
      BusLength = NF_COMMON_BUS_LENGTH,     --20M共享内存
      IdleSleepUS = 1000,
      ServerIp = NF_INTER_SERVER_IP,
      ServerPort = NF_INTER_SERVER_PORT+NF_ST_CITY_SERVER*10+1,
